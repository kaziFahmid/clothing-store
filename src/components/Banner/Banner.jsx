...
const Banner = () => {
  ...
  <div id="slide1" className="carousel-item relative w-full bg-[url(https://i.ibb.co/2t90rfL/pexels-andrea-piacquadio-842811-min.jpg)] bg-center bg-cover bg-no-repeat h-[500px] flex justify-center items-center">
<div className=" max-w-6xl">
  <h1 className="text-white text-6xl font-semibold">Discover the Latest Fashion Trends</h1>
  ...
  <div className="mt-3">
    ...
    <div className="absolute flex justify-center gap-5 transform  left-5 right-5 top-3/4">
      <a href="#slide4" className="btn rounded-none btn-square bg-black text-white border-none">❮</a> 
  ...
  <div id="slide2" className="carousel-item relative w-full bg-[url(https://i.ibb.co/Lz3Q2hM/freestocks-3-Q3ts-J01nc-unsplash-min-2.jpg)] bg-center bg-cover bg-no-repeat h-[500px] flex justify-center items-center">
  <div className=" max-w-6xl">
  ...
  <div id="slide3" className="carousel-item relative w-full bg-[url(https://i.ibb.co/XXG7LFJ/pexels-iiii-iiii-69212-min.jpg)] bg-center bg-cover bg-no-repeat h-[500px] flex justify-center items-center">
  <div className=" max-w-6xl">
